...
DEFAULT_TTS_VALLEX_CONFIG_PATH = Path("modules/tts_vallex/config/settings.yaml")
DEFAULT_LIPSYNC_CONFIG_PATH = Path("modules/lipsync_wav2lip/config/settings.yaml")
