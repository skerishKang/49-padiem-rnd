<style>
    /* PDF 출력 시 머리글/바닥글 제거 및 여백 제어 */
    @media print {
        @page { 
            margin: 0; /* 시스템 머리글/바닥글(파일명, 날짜) 제거 */
        }
        body { 
            margin: 20mm; /* 실제 문서 내부 여백 설정 */
        }
...
<p align="center">
    <img src="최종보고서_이미지/1-4정리_new.png" width="90%" alt="1-4. 추진 경과 및 기대 효과 성과 요약">
</p>
