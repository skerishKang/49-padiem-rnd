...
- **6. 연구개발성과의 관리 및 활용 계획**
  ...
  - 6-2. 서비스/사업 적용 및 확산
    - 6-2-1. 연구개발성과 활용 계획표(양식 기준)
    - 6-2-2. API/상용 서비스 시나리오
  - 6-3. 후속 R&D 및 지식 확산
- **7. 별첨자료(참고 문헌 등)**
  - 참고문헌
...
최근 OTT 및 유튜브 등 글로벌 콘텐츠 시장이 급성장함에 따라 다국어 더빙 수요가 증가하고 있으나, 기존 더빙 제작 방식은 언어별 스크립트 작성, 전문 성우 섭외 및 녹음, 영상 편집 및 입 모양(Lip-sync) 싱크 작업을 단계별 수작업으로 처리해야 하는 구조적 한계가 있음. 이로 인해 제작 비용이 높고 제작 기간이 길어, 자원이 제한된 중소기업 및 개인 창작자가 글로벌 시장에 진출하는 데 큰 진입 장벽으로 작용하였음.

- 글로벌 수요 지표: 2024년 전통 더빙/영화 더빙 시장은 약 40.4억 달러 규모이며 2033년 75.5억 달러로 성장(연평균 7.19%) 전망 (출처: GlobalGrowthInsights, Film Dubbing Market, https://www.globalgrowthinsights.com/market-reports/film-dubbing-market-102061). 더빙·자막 통합 시장에서는 OTT 파트너십 비중이 29%, 2024년 출시 신제품의 34%가 실시간 자막·다국어 AI 기능을 포함 (출처: GlobalGrowthInsights, Dubbing & Subtitling Market, https://www.globalgrowthinsights.com/market-reports/dubbing-and-subtitling-market-117679).
- 글로벌 수요 지표(시각 자료):

  - 영화 더빙 시장 규모 및 CAGR 그래프![Film Dubbing Market](최종보고서_이미지/film_dubbing_market_kr_1766512534168.png)
    - 출처: GlobalGrowthInsights (2024), Film Dubbing Market (https://www.globalgrowthinsights.com/market-reports/film-dubbing-market-102061)
  - 더빙·자막 시장 규모 및 CAGR 그래프![Dubbing & Subtitling Market](최종보고서_이미지/film_dubbing_market_bar_kr.png)
    - 출처: GlobalGrowthInsights (2024), Dubbing & Subtitling Market (https://www.globalgrowthinsights.com/market-reports/dubbing-and-subtitling-market-117679)
- 전통 수작업 공정(구조적 한계): ① 번역/각색 → ② 캐스팅(성우/감독) → ③ 스튜디오 녹음 → ④ 클린업/노이즈 제거 → ⑤ 타이밍·Lip-sync 편집 → ⑥ 믹싱(M&E) → ⑦ QC/리뷰 → ⑧ 재녹음(픽업). 다수 인력의 순차 투입, 스튜디오·성우 슬롯 의존, 언어별/회차별 반복 작업으로 병목이 발생하며, 다국어 동시 출시가 어렵고 리드타임이 선형 증가함.
- 비용 부담(전통 방식): 방송/극장급 더빙은 분당 $50~60(일부 $75까지) 수준, 기본 품질도 분당 $20~30이 일반적 (출처: Checksub, Dubbing Price Guide, https://www.checksub.com/blog/dubbing-price-guide ; BunnyStudio Blog, How much does a dub cost, https://bunnystudio.com/blog/how-much-does-a-dub-cost-the-latest-pricing-formula/). (환율 1,450원 적용 시: 기본 품질 29,000~43,500원/분, 방송·극장급 72,500~87,000원/분, 고급 사례 108,750원/분). 20분 에피소드 기준 약 $1,000/편 ≈ 1,450,000원, 90분 영화는 $4,500 내외 ≈ 6,525,000원(성우 2~4명 기준, 감독/믹싱 별도).

  참고: 상기 단가는 온라인 가이드의 “분당 x 러닝타임” 단순 곱 기준으로, 성우 수·디렉팅/재녹음 횟수·스튜디오 등급·믹싱/마스터링·번역/자막/QC 포함 여부에 따라 총액은 더 높아지는 것이 일반적임(실무 견적에서는 90분 단가가 6백만 원 이상으로 상승).
- 기간 부담(전통 방식): 준비·번역 2~3일, 캐스팅/계약 2~5일, 녹음 1~3일, 편집·믹싱·QC 2~4일 등 언어당 1~3주가 소요되며, 다언어 병렬 처리가 어려울 경우 언어 수만큼 시간이 증가. 이 때문에 중소 제작사·개인 창작자는 비용·기간 측면에서 글로벌 진출 장벽이 높음.
...
- 근거(내부): 과제접수용연구개발계획서(PART2(본문1))
  - 계획서 원문 발췌(목표 정의)
    ![계획서 목표 p1](최종보고서_이미지/근거/계획서_목표_p1.jpg)
    ![계획서 목표 p3](최종보고서_이미지/근거/계획서_목표_p3.jpg)
...
- 하이브리드 모델 구조(내부 구성) 시각 자료![Hybrid Model](최종보고서_이미지/hybrid_system_kr_v.png)
  - 캡션: STT→번역→TTS→RVC→립싱크 모듈 흐름(내부 구조)
...
- 근거(내부): 과제접수용연구개발계획서(PART2(본문1))(기대효과: 기술/경제/사회), (사업화 전략 KPI 예시), (장기 파급효과)
  ...
  - 계획서 원문 발췌(사업화 전략·기대효과·파급효과)
    ![계획서 KPI p21](최종보고서_이미지/근거/계획서_KPI_p21.jpg)
    ![계획서 KPI p22](최종보고서_이미지/근거/계획서_KPI_p22.jpg)
    ![계획서 기대효과 p23](최종보고서_이미지/근거/계획서_기대효과_p23.jpg)
    ![계획서 파급효과 p24](최종보고서_이미지/근거/계획서_파급효과_p24.jpg)
...
다음은 파이프라인 단계별 구현/근거를 표 대신 간략 리스트로 정리한 것임. 주요 파일과 핵심 로직을 함께 병기함.

- 오디오 추출: `modules/audio_extractor/run.py`, `config/settings.yaml` (FFmpeg 경로·코덱·샘플레이트 설정)
...
- STT(Whisper): `modules/stt_whisper/run.py`, `config/settings*.yaml` (`openai/whisper` 기반, segment JSON 산출)
...
transcript = {"text": result.get("text", "").strip(), "segments": segments}
...
- STT(Gemini, 선택): `modules/stt_gemini/run.py` (API 보완 경로)
- 텍스트 처리/번역: `modules/text_processor/run.py`, `config/settings.yaml`, `docs/timed_translation_spec.md` (정규화·길이/타이밍 정합, `_filter_hallucinations`, `_batch_translate_segments`)
...
`modules/text_processor/config/settings.yaml`
...
- TTS(VALL-E X): `modules/tts_vallex/run.py`, `config/settings.yaml` (외부 스크립트 실행 템플릿)
...
```yaml
script_path: modules/tts_vallex/scripts/infer.sh
checkpoint_dir: checkpoints/vallex
speaker_id: 0
command_template: >
  {script_path} --ckpt {checkpoint_dir} --prompt {prompt_wav} --text "{text}"
```

- TTS(XTTS, 백업): `modules/tts_xtts/run.py`, `config/settings.yaml` (백업 경로)
...
use_gpu: true
speaker_wav: samples/prompt.wav
language: en
```

- TTS(Gemini, 선택): `modules/tts_gemini/run.py` (API 합성 선택 경로)
...
save_audio(gen, output_wav)
```

- 음색 변환(RVC): `modules/voice_conversion_rvc/run.py`, `config/settings.yaml` (checkpoint·f0_method 등 VC 설정)
...
save_audio(output_wav, converted, sr=sample_rate)
```

`modules/voice_conversion_rvc/config/settings.yaml`

```yaml
checkpoint: checkpoints/rvc.pth
f0_method: harvest
pitch_shift: 0
sample_rate: 44100
```

- 립싱크(Wav2Lip): `modules/lipsync_wav2lip/run.py`, `config/settings.yaml` (외부 모델 경로, face detector)
...
`modules/lipsync_wav2lip/config/settings.yaml`
...
- 립싱크(MuseTalk): `modules/lipsync_musetalk/run.py`, `config/settings.yaml` (`fp16: True` 옵션)
...
`modules/lipsync_musetalk/config/settings.yaml`

```yaml
checkpoint: checkpoints/musetalk.safetensors
fp16: true
resolution: 720
```

- Orchestrator: `orchestrator/pipeline_runner.py`, `orchestrator/config.yaml` (단계별 CLI 호출 시퀀스)
...
- 백엔드: `backend/main.py`, `backend/job_manager.py`, `backend/routers/*` (모듈 실행 API/비동기 Job)
  `backend/main.py`
...
- 프론트엔드: `frontend_unified/Home.py`, `pages/*`, `steps/*` (Streamlit 통합 UI)
...
- TensorRT 엔진 변환(옵션 단계, `pipeline_type=video_trt`): `modules/experimental/onnx_export_stub.py`, `modules/experimental/tensorrt_export.py`
  `modules/experimental/onnx_export_stub.py`
...
`modules/experimental/tensorrt_export.py`
...
- (추가연구) 보컬 분리(Demucs): `modules/experimental/demucs_run.py` (계획서 미명시, 연구노트 2024-11-04 기반)
  `modules/experimental/demucs_run.py`
...
- (추가연구) VAD 기반 무음 필터: `modules/experimental/vad_stub.py` (계획서 미명시, 연구노트 2024-10-23 기반)
  `modules/experimental/vad_stub.py`
...
- (검토) TensorRT 적용 상태: 강혜림 연구노트(2024-10-16) 커스텀 op 불일치로 엔진 미생성 → 위 스텁/스크립트 추가, ONNX 실출력·trtexec 경로 설정 후 엔진 생성/로드 필요
- 파이프라인 흐름도(내부 모듈 기준)![Pipeline Flow](최종보고서_이미지/pipeline_flow.png)

  - 캡션: 입력→FFmpeg→STT→번역→TTS/VC→립싱크→렌더링

#### 근거 발췌(연구노트)

다음은 전체 파이프라인 설계(모듈형 구조, 단계 구성, 모델 선정)에 대한 연구노트의 핵심 기록 발췌임.

- 강철원 연구노트(2024-10-10, 시스템전체구조정의) 발췌: "**목표**: 유튜브 등 영상 콘텐츠의 다국어 더빙 자동화 시스템 개발"
- 강철원 연구노트(2024-10-10, 시스템전체구조정의) 발췌: "**입력**: MP4 비디오 / **출력**: 더빙된 MP4 비디오"
- 강철원 연구노트(2024-10-10, 시스템전체구조정의) 발췌: "**AI Models**: Whisper(STT), VALL-E X(TTS), RVC(VC), Wav2Lip(LipSync)"
- 강철원 연구노트(2024-10-11, 자막입력및AI모듈설계) 발췌: "**모듈형 구조** 채택, 기능별(STT/TTS/VC 등) 독립 모듈화로 유지보수성 향상"
- 강철원 연구노트(2024-10-11, 자막입력및AI모듈설계) 발췌: "`Input Video` → `Audio Extraction` → `STT` → `Translation` → `TTS` → `RVC` → `Wav2Lip` → `Output Video`"
- 강철원 연구노트(2024-10-17, RVC및VALLEX분석) 발췌: "**Hybrid Approach**: VALL-E X로 1차 생성(발음, 언어 처리) → RVC로 2차 보정(음색 강화)"
- 강철원 연구노트(2024-10-18, Wav2Lip분석및주간정리) 발췌: "**STT**: Faster-Whisper (Large-v3) / **TTS**: VALL-E X / **VC**: RVC v2 / **LipSync**: Wav2Lip(+GAN)"
- 강철원 연구노트(2024-10-31, 10월성과정리) 발췌: "**주요 산출물**: 요구사항 정의서, 시스템 아키텍처 설계도, 오디오 추출 및 STT 프로토타입 코드"
...
| 3~6. 학습 데이터/학습(음성 추출·강화·무음 처리·학습) | 전처리/학습은 별도 자산/운영 항목 | `2-1-1`의 Demucs/VAD 검토 기록                                                      | 본 공개 레포지토리는 추론 중심               |
...
| 11~12. 자막 생성/자막 맞추기                         | JSON을 기반으로 후처리 가능       | (본 레포지토리 내 SRT/VTT 생성 스크립트는 확인되지 않음)                            | 표준 JSON을 단일 진실원천으로 유지           |
...
다음은 전처리(Demucs) 및 VAD 적용에 대한 연구노트의 핵심 기록 발췌이며, 본 레포지토리 통합 파이프라인에 직접 포함되지 않았음을 병기하였음.
...
>
> (notev2/Kangchulwonv2/2024-11/20241101_UI구조세팅.md) "- **목표**: 업로드된 비디오 파일에서 오디오 트랙만 분리하여 WAV 포맷으로 저장."
>
> (notev2/Kangchulwonv2/2024-11/20241101_UI구조세팅.md) "- **도구**: `ffmpeg-python` 래퍼 라이브러리 대신 `subprocess`로 직접 FFmpeg 호출 (제어권 확보)." / "- **설정**: 16kHz, Mono 채널 (Whisper 및 이후 TTS 모델 학습 데이터 표준)."
>
> (notev2/Kangchulwonv2/2024-10/20241021_RVC데이터셋준비.md) "- 영상 처리를 위한 필수 도구인 FFmpeg 설치." / "- 시스템 환경 변수(PATH)에 등록하여 터미널에서 접근 가능하도록 설정."
>
> (notev2/Kangchulwonv2/2024-10/20241021_RVC데이터셋준비.md) "- **옵션**: 샘플 레이트(16k, 44.1k), 채널(Mono/Stereo) 설정 가능하도록 설계."
>
> (notev2/Kangchulwonv2/2024-10/20241021_RVC데이터셋준비.md) "- **경로 문제**: 윈도우 경로(\\)와 FFmpeg 경로(/) 호환성. -> `pathlib` 라이브러리 사용하여 경로 처리 표준화."
...
다음은 STT 프로토타이핑 단계에서 Whisper 기반 전사, 세그먼트 기반 SRT 변환, 무음 구간 환각 이슈를 기록한 연구노트 발췌이며, 일부는 `faster-whisper` 기반 실험 기록을 포함함.

> (notev2/Kangchulwonv2/2024-10/20241022_RVC학습및추론.md) "- `faster-whisper` 라이브러리 설치." / "- 어제 추출한 오디오 파일을 입력으로 넣어 텍스트 변환 테스트."
>
> (notev2/Kangchulwonv2/2024-10/20241022_RVC학습및추론.md) "- Whisper 결과(Segments)를 파싱하여 SRT(SubRip Subtitle) 형식으로 변환하는 로직 구현." / "- 타임스탬프(Start, End) 포맷팅 (`00:00:00,000`)."
>
> (notev2/Kangchulwonv2/2024-10/20241022_RVC학습및추론.md) "- **환각(Hallucination)**: 무음 구간에서 이상한 텍스트 반복 생성. -> VAD(Voice Activity Detection) 필터링 옵션 활성화 필요."
...
- 환각(반복) 세그먼트 억제: STT 출력에서 동일 텍스트 반복 시 세그먼트를 병합하는 필터를 적용하여, 무음 구간 환각으로 인한 번역/정합 붕괴를 완화하였음.

  - 근거: `modules/text_processor/run.py`의 `_filter_hallucinations()`
- 용어/고유명사 치환(간이 용어집): `translation_map` 설정을 통해, 특정 원문 문자열을 사전에 정의한 문자열로 치환하여 번역 결과의 일관성을 유지할 수 있도록 구성하였음.

  - 근거: `modules/text_processor/config/settings.yaml`, `modules/text_processor/run.py`의 `translation_map` 적용
- LLM 기반 번역(선택): 서비스 환경에서 Gemini API를 활용하여 문맥을 반영한 번역 품질을 확보하도록 구성하였음.
- 배치 번역(문맥 일관성): `gemini_api_key`가 설정된 경우 세그먼트 전체를 JSON payload로 묶어 Gemini에 1회 호출로 번역하여, 문맥 일관성을 확보하도록 구성하였음.

  - 근거: `modules/text_processor/run.py`의 `_batch_translate_segments()`
...
- STT→정규화→번역→길이/타이밍 정합 흐름도![STT Translation Flow](최종보고서_이미지/stt_translation_flow.png)

  - 캡션: STT→정규화→번역→길이/타이밍 정합(LLM·용어집·시간 맞춤)

#### 근거 발췌(연구노트)

다음은 번역 단계에서 문맥 끊김/오역 문제를 해결하기 위한 슬라이딩 윈도우(Chunking) 및 용어집(고유명사 보존) 기법을 검토한 연구노트 발췌이며, 텍스트 정규화/문장 분리/길이 제한 등 후속 고도화 방향을 포함함.

> (notev2/Kangchulwonv2/2024-12/20241209_부하테스트계획.md) "- 자막을 한 줄씩 번역하면 앞뒤 문맥이 끊겨 오역 발생." / "- 예: \"It works.\" -> \"그것은 일한다.\" (문맥상 \"작동한다\"가 맞음)."
>
> (notev2/Kangchulwonv2/2024-12/20241209_부하테스트계획.md) "- 현재 문장을 번역할 때 앞뒤 문장을 같이 프롬프트로 제공하거나, 덩어리(Chunk)로 묶어서 번역."
>
> (notev2/Kangchulwonv2/2024-12/20241209_부하테스트계획.md) "- Deep Translator는 문맥 인식이 약하므로, 5~10문장씩 묶어서 `\\n`으로 연결해 보내는 방식 채택."
>
> (notev2/Kangchulwonv2/2024-12/20241209_부하테스트계획.md) "- **정렬**: 묶어서 번역 후 다시 나눌 때, 번역 API가 문장 개수를 다르게 반환하면 매칭 실패. -> 줄바꿈 문자를 특수 토큰(`|||`)으로 변경하여 보존성 높임."
>
> (notev2/Kangchulwonv2/2024-12/20241210_부하테스트실행.md) "- 사용자 정의 사전(Dictionary)을 로드." / "- 번역 **전**에 고유명사를 플레이스홀더(Placeholder)로 치환." / "- 번역 **후**에 플레이스홀더를 목표 언어 단어로 복원."
>
> (notev2/Kangchulwonv2/2024-12/20241210_부하테스트실행.md) "- 예: `{\"파디엠\": \"Padiem\"}` -> \"파디엠에서 개발\" -> \"[TERM_0]에서 개발\" -> \"Developed at [TERM_0]\" -> \"Developed at Padiem\"."
>
> (notev2/Kangchulwonv2/2024-12/20241210_부하테스트실행.md) "- 번역기가 번역하지 않도록 특이한 형태(`__GLOSSARY_0__`) 사용."
>
> (notev2/Kangchulwonv2/2024-12/20241202_Wav2Lip가속화조사.md) "- STT 결과물이나 번역 결과물에 포함된 숫자, 약어, 기호 등을 TTS가 읽기 좋은 형태로 변환해야 함." / "- 예: \"12/25\" -> \"십이월 이십오일\" (Korean), \"December twenty-fifth\" (English)."
>
> (notev2/Kangchulwonv2/2024-12/20241202_Wav2Lip가속화조사.md) "- **Korean**: `kss` (문장 분리), `jamo` (자모 분리). 숫자 읽기는 정규식 기반 커스텀 로직 필요." / "- **English**: `num2words` 라이브러리 활용."
>
> (notev2/Kangchulwonv2/2024-12/20241203_TensorRT벤치마킹.md) "- 단순 마침표(`.`) 기준 분리는 \"Mr. Kim\" 같은 약어에서 오작동." / "- `nltk.sent_tokenize` (영어)와 `kss.split_sentences` (한국어)를 언어별로 분기 처리."
>
> (notev2/Kangchulwonv2/2024-12/20241203_TensorRT벤치마킹.md) "- TTS 모델(VALL-E X) 입력 한계(약 15~20초)를 고려하여, 문장이 너무 길면 쉼표(`,`)나 접속사 기준으로 강제 분할하는 로직 추가."
...
- TTS 참고 시각 자료:
  - VALL-E X(MS Research) 프로젝트 페이지(품질/유사도 강조)
    ![VALL-E X](최종보고서_이미지/valle_x_ms.png)

#### 근거 발췌(연구노트)

> (notev2/Kangchulwonv2/2024-10/20241017_RVC및VALLEX분석.md) "- **특징**: 마이크로소프트 리서치에서 발표. 3초 분량의 음성 샘플만으로 목소리 복제 가능 (Zero-shot). 다국어 지원." / "- **장점**: 교차 언어(Cross-lingual) 합성 가능 (예: 한국인 목소리로 영어 발화)."
>
> (notev2/Kangchulwonv2/2024-10/20241017_RVC및VALLEX분석.md) "- **특징**: Retrieval-based Voice Conversion. 적은 데이터로도 고품질 음성 변환 가능." / "- **활용**: VALL-E X로 생성된 음성의 톤을 원본 화자와 더욱 비슷하게 보정하는 용도로 사용 계획."
>
> (notev2/Kangchulwonv2/2024-10/20241017_RVC및VALLEX분석.md) "- **Hybrid Approach**: VALL-E X로 1차 생성(발음, 언어 처리) -> RVC로 2차 보정(음색 강화)."
>
> (notev2/Kangchulwonv2/2024-11/20241115_VALLEX준비및주간정리.md) "- 다음 단계인 음성 합성(TTS)을 위해 VALL-E X 리포지토리 클론 및 의존성 설치." / "- `phonemizer`: 텍스트를 음소(Phoneme)로 변환하는 라이브러리 설치 필수 (VALL-E X 의존성)."
>
> (notev2/Kangchulwonv2/2024-11/20241115_VALLEX준비및주간정리.md) "- **Espeak**: `phonemizer` 사용을 위해 시스템에 `espeak-ng` 백엔드 설치 필요. 윈도우 환경 변수 설정 주의."
>
> (notev2/Kangchulwonv2/2024-11/20241118_VALLEX전처리.md) "- **AR (Auto-Regressive) Model**: 텍스트와 프롬프트 오디오의 음향 토큰을 기반으로 첫 번째 양자화기(Quantizer)의 코드를 생성." / "- **NAR (Non-Auto-Regressive) Model**: 나머지 7개의 양자화기 코드를 병렬로 생성하여 정밀도 향상." / "- **Vocoder**: 생성된 코드를 오디오 파형으로 변환 (HiFi-GAN 등 사용)."
>
> (notev2/Kangchulwonv2/2024-11/20241118_VALLEX전처리.md) "- VALL-E X는 텍스트뿐만 아니라 \"3초 오디오 프롬프트\"를 입력으로 받아, 그 목소리 톤을 모방(Cloning)하는 것이 핵심."
>
> (notev2/Kangchulwonv2/2024-11/20241118_VALLEX전처리.md) "- **복잡성**: 코드가 연구용이라 구조가 복잡하고 하드코딩된 경로가 많음. -> 모듈화 필요."
>
> (notev2/Kangchulwonv2/2024-11/20241119_VALLEX학습시도.md) "- 제공된 체크포인트(`checkpoints/`)를 로드하여 텍스트 -> 음성 생성 테스트." / "- **결과**: 영어 텍스트 입력 시 자연스러운 영어 음성 생성 확인." / "- **속도**: CPU에서는 매우 느림. GPU 필수." / "- **메모리**: VRAM 6GB 이상 권장."
>
> (notev2/Kangchulwonv2/2024-11/20241120_LoRA도입검토.md) "- 복잡한 VALL-E X 코드를 `TTSGenerator` 클래스로 래핑." / "- `generate(text, prompt_path, language)` 메서드 제공." / "- 모델 로딩 로직을 클래스 초기화 시점으로 이동." / "- **긴 문장**: 문장이 너무 길면(20초 이상) 생성이 끊기거나 품질 저하. -> 문장 분리(Sentence Splitting) 전처리 필요."
>
> (notev2/Kangchulwonv2/2024-11/20241121_VALLEX_LoRA학습.md) "- `nltk` 또는 `kss`(한국어) 라이브러리 활용하여 긴 텍스트를 문장 단위로 분할." / "- VALL-E X 입력 길이를 최적화하여 안정성 확보."
...
- 립싱크 참고 시각 자료:
  - Wav2Lip 공식 리포지토리 개요(모델 구조/데모)![Wav2Lip GitHub](최종보고서_이미지/wav2lip_github.png)
    - 출처: https://github.com/Rudrabha/Wav2Lip
  - MuseTalk 공식 리포지토리 개요(고해상도/실시간 강조)![MuseTalk GitHub](최종보고서_이미지/musetalk_github.png)
    - 출처: https://github.com/TMElyralab/MuseTalk
  - Wav2Lip ↔ MuseTalk 비교 썸네일(화질/입모양 대비)![LipSync Compare](최종보고서_이미지/lipsync_compare.png)
    - 캡션: 왼쪽=Wav2Lip, 오른쪽=MuseTalk

#### 근거 발췌(연구노트)

> (notev2/Kangchulwonv2/2024-10/20241018_Wav2Lip분석및주간정리.md) "- **특징**: 임의의 오디오와 비디오를 입력받아 입모양을 동기화." / "- **성능**: 현재 공개된 모델 중 가장 안정적인 성능. GAN 기반." / "- **제약**: 상업적 이용 시 라이선스 확인 필요 (LRS2 데이터셋 이슈). 연구용으로 우선 진행."
>
> (notev2/Kangchulwonv2/2024-10/20241018_Wav2Lip분석및주간정리.md) "- **라이선스**: Wav2Lip의 상업적 이용 제한. -> 대체 모델(SadTalker 등)도 지속 모니터링하되, 현재는 Wav2Lip으로 프로토타입 개발."
>
> (notev2/Kanghyerim/연구노트.txt) "목표: 임의의 오디오에 맞춰 비디오 속 인물의 입모양을 동기화." / "구조: Generator(입모양 생성) + Discriminator(품질 판별) + Expert Sync Net(동기화 판별)." / "SyncNet loss is crucial for accurate lip-sync."
>
> (notev2/Kanghyerim/연구노트.txt) "LRS2 데이터셋 라이선스 문제로 상업적 이용 시 주의 필요." / "현재는 연구 개발 단계이므로 사용 가능하나, 추후 자체 데이터셋 학습 고려."
>
> (notev2/Kanghyerim/연구노트.txt) "해상도: 기본 모델은 96x96 해상도로 입모양을 생성하여 전체 영상 품질 저하 우려. -> GFPGAN 등 Super-resolution 도입 필수."
>
> (notev2/Kangchulwonv2/2025-08/20250804_라이선스검토.md) "- **Wav2Lip**: LRS2 데이터셋 사용 시 비상업적 용도 제한 있음. -> 상업적 이용을 위해 자체 데이터셋으로 재학습하거나, 연구용 프로토타입으로 한정해야 함." / "- 현재 단계에서는 **\"연구용 프로토타입\"** 으로 정의하고, 상용 서비스 출시 전 Wav2Lip 모델 교체 또는 재학습 계획 수립."
>
> (notev2/Kangchulwonv2/2025-02/20250224_성능최적화1.md) "- **결과**: 성공. 하지만 오디오와 비디오 싱크가 미세하게 밀리는 현상 발견." / "- **싱크 밀림**: Wav2Lip 처리 과정에서 프레임 레이트(FPS)가 변경되거나 오디오 길이가 달라질 수 있음. -> FFmpeg로 최종 합칠 때 오디오 길이에 맞춰 비디오 속도 조절(Stretch) 필요."
>
> (notev2/Kanghyerim_Combined_2024-10_to_2025-09_plain.txt) "립싱크 품질을 단순 주관 평가가 아니라 PSNR/FID와 같은 정량 지표로 관리하기로 결정함." / "Wav2Lip을 초기 베이스라인으로 두되, \"서비스에 투입 가능한 고해상도 립싱크\"라는 목표 수준을 지표 상으로도 분명히 정의하고, 이후 모델/파이프라인 변경 논의의 기준점으로 사용."
>
> (notev2/Kanghyerim_Combined_2024-10_to_2025-09_plain.txt) "대체 모델 후보군 중 MuseTalk가 고해상도 립싱크실시간 처리 측면에서 가장 유망한 후보로 보고받음." / "초기 PoC 결과에서 Wav2Lip 대비 PSNR/FID와 시각적 선명도가 모두 개선되는 경향이 확인되어, MuseTalk 기반 PoC를 공식 과제로 승인."
>
> (notev2/Kanghyerim_Combined_2024-10_to_2025-09_plain.txt) "MuseTalk 기반 립싱크 모듈을 통합한 후, 전체 평가셋 기준으로 PSNR/FID 목표치를 달성유지할 수 있다는 최종 보고를 받음." / "기본 립싱크 엔진은 MuseTalk으로 전환." / "Wav2Lip은 호환성 보장 및 장애특수 케이스 대응용 fallback 엔진으로만 사용."
...
- 초기 성능 계측 기록(내부): 5초 clip 기준 평균 추론 지연시간 342ms, throughput 2.7 clips/s, GPU 메모리 사용량 약 38GB를 기록하였음. 해당 수치는 연구노트 기반 초기 기록이며, 시험성적서용 공식 수치로는 별도 재현 및 검증이 필요함.
  - 근거: `notev2/Kanghyerim/2024-10/20241016.md`
- 성능 리포트 자동화 도구: clip 길이별 지연/메모리/throughput 기록용 실행 절차 및 스크립트 설계 문서를 내부 시험랩(`test_reports_company`, 공개 제외)에서 정리하였으며, 본 레포지토리에도 `finalv2/scripts/benchmark_runner.py`를 구현하여 clip 단위 성능 로그를 CSV로 기록할 수 있도록 구성하였음.
...
- GPU 가속 참고 시각 자료:
  - TensorRT-LLM 가속 사례(엔비디아 공식 블로그)![TensorRT LLM](최종보고서_이미지/tensorrt_llm.png)
  - GPU 최적화 스택(캐싱/fp16/체크포인팅/변환 검토)![GPU Stack](최종보고서_이미지/gpu_stack.png)
    - 캡션: fp16·체크포인팅·캐싱 중심 가속 스택
...
다음은 GPU 최적화(혼합정밀도/체크포인팅), TensorRT INT8 calibration 검토, 모델 언로딩(ResourceManager) 기반 메모리 관리, 캐싱 전략(키 설계/TTL) 및 모델 변환 보류 의사결정(캐싱 집중)을 기록한 연구노트 발췌임.

> (notev2/Kanghyerim/2024-10/20241016.md) "- NVIDIA A100 80GB x2, CUDA 12.3, PyTorch 2.2, TensorRT 9.1 조합으로 벤치마크 환경 구성." / "- fp16 mixed precision과 gradient checkpointing을 도입해 메모리 사용량을 52GB → 34GB로 감소."
>
> (notev2/Kanghyerim/2024-10/20241016.md) "- FastPitch, Wav2Lip 추론 그래프에 대해 TensorRT INT8 calibration을 수행." / "- 초기 결과로 약 1.4배 추론 속도 향상 가능성을 확인."
>
> (notev2/Kangchulwonv2/2025-01/20250121_메모리누수점검.md) "- VRAM 12GB 환경에서 Whisper(Large), VALL-E X, RVC를 모두 올리면 OOM 발생 위험." / "- 각 단계가 끝나면 `del model`, `torch.cuda.empty_cache()`를 호출하여 메모리 확보." / "- **타협**: Whisper는 상주시키고, TTS/RVC는 필요 시 로드/언로드."
>
> (notev2/Kangchulwonv2/2025-01/20250121_메모리누수점검.md) "- `ResourceManager` 클래스 구현하여 모델 수명 주기 관리."
>
> (notev2/Kangchulwonv2/2025-04/20250407_캐싱전략.md) "- **번역**: 동일한 원문 -> 동일한 번역문." / "- **TTS**: 동일한 텍스트 + 동일한 화자 -> 동일한 오디오." / "- **RVC**: 동일한 소스 오디오 + 동일한 타겟 모델 -> 동일한 변환 오디오."
>
> (notev2/Kangchulwonv2/2025-04/20250407_캐싱전략.md) "- `TTS:{text_hash}:{speaker_id}`" / "- `RVC:{audio_hash}:{model_id}`" / "- **오디오 해시**: 오디오 파일 전체를 해싱하면 느림. -> 파일명(UUID) 의존. UUID가 안전."
>
> (notev2/Kangchulwonv2/2025-04/20250408_Redis캐싱구현.md) "- `modules/utils/cache.py` 작성." / "- 데코레이터 패턴(`@cached`)을 사용하여 함수 호출 결과를 Redis에 저장/조회." / "- 오디오 데이터는 파일 시스템에 저장하고 경로만 Redis에 저장."
>
> (notev2/Kangchulwonv2/2025-04/20250408_Redis캐싱구현.md) "- **TTL**: 캐시 만료 시간 설정 필요. -> 일단 24시간 TTL 설정."
>
...
- 품질 관리(정량 평가) 체계: 본 레포지토리의 서비스 파이프라인과 별도로, 정량 지표 산출은 평가 스크립트/결과 JSON 형태로 관리하였음.
  - WER/BLEU/PSNR/FID 산출 스크립트: 문서상 설계(`test_reports_company/docs/process/b_metrics_plan_v1.md`, 공개 제외)와 기존 결과 JSON 스키마를 기준으로, 본 레포지토리에 `finalv2/scripts/measure_wer.py`, `finalv2/scripts/measure_wer_normalized.py`, `finalv2/scripts/measure_bleu.py`, `finalv2/scripts/measure_psnr_fid.py`를 구현하여 동일 입력에 대해 동일 포맷의 결과(JSON)를 산출할 수 있도록 구성하였음.
  - 결과 예시(대표 샘플):
...
다음은 백엔드(FastAPI) 구조 및 엔드포인트, 비동기 작업 큐 설계(Celery/Redis), 작업 상태 관리 및 진행률 표시, 실시간 업데이트 방식(Polling/WebSocket/SSE) 비교, Streamlit 기반 UI 및 자막 편집 UI 구성을 기록한 연구노트 발췌임.

> (notev2/Kangchulwonv2/2025-03/20250303_FastAPI구조설계.md) "- **프레임워크**: FastAPI (비동기 지원, 자동 문서화)." / "- **구조**: `app/main.py`, `app/api/`, `app/core/`, `app/services/`, `app/schemas/`."
>
> (notev2/Kangchulwonv2/2025-03/20250303_FastAPI구조설계.md) "- `poetry` 대신 `pip` + `requirements.txt` 사용 (팀원 익숙함 고려)." / "- 기본 `Health Check` API 구현."
>
> (notev2/Kangchulwonv2/2025-03/20250304_API엔드포인트.md) "- `POST /upload`: 비디오 파일을 받아 `data/inputs`에 저장." / "- `UploadFile` 타입 사용. 대용량 파일 처리를 위해 `shutil.copyfileobj` 활용."
>
> (notev2/Kangchulwonv2/2025-03/20250304_API엔드포인트.md) "- `POST /process`: 업로드된 파일 ID와 타겟 언어를 받아 작업 시작." / "- **블로킹**: 처리 API 호출 시 AI 모델이 돌면서 서버가 멈춤. -> 비동기 큐(Celery) 도입 시급."
>
> (notev2/Kangchulwonv2/2025-03/20250305_비동기설계.md) "- AI 모델 추론은 CPU/GPU를 점유하며 시간이 오래 걸림 (수 분 ~ 수십 분)." / "- HTTP 요청은 타임아웃이 있으므로, 요청만 받고 실제 작업은 백그라운드 워커(Worker)에게 위임해야 함."
>
> (notev2/Kangchulwonv2/2025-03/20250305_비동기설계.md) "- **Broker**: Redis" / "- **Worker**: Celery" / "- **Flow**: API -> Redis -> Celery Worker -> AI Module."
>
> (notev2/Kangchulwonv2/2025-03/20250305_비동기설계.md) "- **윈도우 호환성**: Redis는 공식적으로 윈도우를 지원하지 않음. -> Memurai(윈도우용 Redis 호환) 사용."
>
> (notev2/Kangchulwonv2/2025-03/20250311_작업상태관리.md) "- 작업 ID(UUID)를 키로 하여 상태(Pending, Processing, Completed, Failed)와 진행률(%)을 저장." / "- `GET /jobs/{job_id}`: 현재 상태 반환."
>
> (notev2/Kangchulwonv2/2025-03/20250311_작업상태관리.md) "- 워커 내부에서 `self.update_state(state='PROGRESS', meta={'current': 50, 'total': 100})` 호출하여 진행률 업데이트."
>
> (notev2/Kangchulwonv2/2025-03/20250312_웹소켓연구.md) "- **Polling**: 클라이언트가 1초마다 API 호출. 구현 쉽지만 서버 부하." / "- **WebSocket**: 양방향 연결. 실시간성 좋지만 구현 복잡." / "- **SSE**: 서버 -> 클라이언트 단방향. 진행률 표시에 적합."
>
> (notev2/Kangchulwonv2/2025-03/20250312_웹소켓연구.md) "- 현재 MVP 단계이고 사용자가 많지 않으므로, 구현이 가장 간단한 Polling 방식 채택. (Streamlit은 Polling이 내장되어 있기도 함)."
>
> (notev2/Kangchulwonv2/2025-03/20250313_실시간진행률.md) "- Audio Extract: 0~10%" / "- STT: 10~30%" / "- Translation: 30~40%" / "- TTS: 40~60%" / "- RVC: 60~80%" / "- Wav2Lip: 80~100%"
>
> (notev2/Kangchulwonv2/2025-03/20250317_Streamlit기획.md) "- Step 1: 비디오 업로드 (Drag & Drop)." / "- Step 4: 진행률 표시 (Progress Bar)." / "- Step 5: 결과 영상 재생 및 다운로드."
>
> (notev2/Kangchulwonv2/2025-04/20250402_자막UI구현.md) "- `st.data_editor`를 사용하여 판다스 DataFrame(자막 데이터)을 엑셀처럼 편집 가능하게 구현." / "- 편집 후 'Save' 버튼을 누르면 변경된 데이터가 백엔드로 전송됨." / "- **타임코드 수정**: 사용자가 시작/종료 시간을 잘못 입력하면 오디오 겹침 발생. -> 유효성 검사(Validation) 로직 추가 필요."

- 근거(내부): `pdf/ocr/본문1 (1)/과제접수용연구개발계획서(PART3(본문2))_page-0007.jpg`(AI 더빙 워크플로우 최적화: RESTful API/작업 진행 관리/실시간 업데이트 등 계획)
...
- 근거(내부): `pdf/ocr/본문1 (1)/과제접수용연구개발계획서(PART3(본문2))_page-0015.jpg`, `pdf/ocr/본문1 (1)/과제접수용연구개발계획서(PART3(본문2))_page-0016.jpg`, `pdf/ocr/[붙임3] GRND-UI-DP-04.사용자 매뉴얼_R&D 포털_평가_ocr.pdf`(평가자료 사전제출/온라인 의견공유/이의신청/보고서 제출/비공개 요청), `pdf/ocr/중요 [전북대학교 산학협력중점사업단] 24년 창업성장기술개발사업 디딤돌..._ocr.pdf`(최종보고서 제출 안내)
...
| 지표            | 목표치      | 대표 실측값                                    | 근거                                                                                          | 비고                                         |
| --------------- | ----------- | ---------------------------------------------- | --------------------------------------------------------------------------------------------- | -------------------------------------------- |
| WER(normalized) | 6.5% 이하   | 10.476% (Whisper large-v3, 한국어 민형배 샘플) | `test_reports_company/data/b_metrics/wer_bleu/wer_results.minhb.largev3.normalized.json`      | 단일 샘플 기준, 추가 샘플 필요               |
| BLEU            | 41.0점 이상 | 44.23 (Whisper medium, 한국어 민형배 샘플)     | `test_reports_company/data/b_metrics/wer_bleu/bleu_results.minhb.medium.json`                 | 목표 초과 달성(표본 한정)                    |
| MOS             | 4.3점 이상  | 4.3 (VALL-E X 연동 테스트)                     | `notev2/Kangchulwonv2/2025-04/20250416_HiFiGAN평가.md`                                        | 내부 주관평가, 보조 SNR 서러게이트 병행 계획 |
| PSNR            | 35dB 이상   | Infinity (ref/gen 동일, Wav2Lip 통합 스모크)   | `test_reports_company/data/b_metrics/psnr_fid/video_quality_results.wav2lip_integration.json` | 스모크용, 추가 샘플 필요                     |
| FID             | 9 이하      | 미측정(`fid_score: None`)                      | 후속 구현 예정                                                                                | Inception 특징 추출 파이프라인 필요          |

- 정량 지표 요약 그래프![Metrics Graph](최종보고서_이미지/metrics_graph.png)
  - 캡션: 목표 vs 실측(WER 6.5→10.48, BLEU 41→44.23, MOS 4.3→4.3, PSNR 35→Infinity*)
    - *Infinity는 ref/gen 동일한 스모크 테스트 결과
...
- 산출 방식(스크립트): JSONL 페어(`ref`, `hyp`)를 입력으로 하여 공백 기반 토큰화 후 Levenshtein 거리로 WER(%)를 계산하고, 참조 토큰 수 기준 가중 평균을 산출하였음.
  - 구현: `finalv2/scripts/measure_wer.py`, `finalv2/scripts/measure_wer_normalized.py`
...
- WER 정의 참고(위키피디아)
  ![WER Wikipedia](최종보고서_이미지/wer_wikipedia.png)
...
- BLEU 정의 참고(위키피디아)
  ![BLEU Wikipedia](최종보고서_이미지/bleu_wikipedia.png)
...
- PSNR/FID 정의 인포그래픽
  ![PSNR FID Infographic](최종보고서_이미지/psnr_fid_infographic.png)
...
- 릴리즈 게이트 흐름도
  ![Release Gate](최종보고서_이미지/release_gate.png)
...
- 단계적 서비스 출시(계획서 기반): 계획서에서는 클로즈드 베타→오픈 베타→정식 출시의 단계적 출시 전략과 초기 사용자 피드백 수집을 제시하였음. 본 과제의 통합 UI/비동기 Job 실행 구조를 기반으로, 테스트 모집·피드백 수집·개선 주기를 운영 프로세스로 내재화할 계획임.
  ...
  - 클로즈드 베타: 초기 1,000명 수준의 테스트 사용자를 모집하여 피드백을 집중 수집하고, 기능 안정성과 품질 관리 체계(QC) 운용성을 우선 검증할 계획임.
